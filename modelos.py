                    ...
                    # while True:
                       ...
                       # rows = s.find("table", {"class": "grab"}).find("tbody").find_all("tr")
                                ...
                                if i == 0:
                                    ...
                                    for j in range(0, len(rows[3].contents), 1):
                                        ...
                                        if i == 1:
                                            ...
                                            wspd.append(rows[i].contents[j].string)
                                        elif i == 6:
                        ...
                        lista_de_tuplas = list(
                            zip(estacao, dd, wspd, wdir, gust, tar, prp, neb, cld, cldcb, vis, tp, datazulu))

                        df = pd.DataFrame(
                            lista_de_tuplas,
                            columns=['estacao', 'datahora', 'wspd', 'wdir', 'gust', 'tar', 'prp', 'neb', 'cld', 'cldcb',
                                     'vis', 'tp', 'datazulu']
                        )
                        print(forecast)
                        if no != 0:
                            ...
                            try:
                                ...
                                if i==0:
                                    for j in range(0,len(rows[0].contents),1):
                                        ...
                                        dataaux.append(datetime.now() + timedelta(days=j))
                                        data.append(rows[i].contents[j].string)
                                        ddd = rows[0].contents[j].contents[0].text[8:10]
                                    ...
                                    for j in range(0,len(rows[3].contents),1):
                                        ...
                                        if i==1:
                                            ...
                                            hhh=(str(rows[1].contents[j])[28:30])
                                            hhh = (str(rows[1].contents[0]))[4:6]
                                             ...
                                             bb=str(int((int(apenasDigitos1))))
                                             #print(bb)
                                             tar.append(bb)
                                             #bb= str(int((int(apenasDigitos2) - 32) * 5/9))
                                             bb= str(int((int(apenasDigitos2))))
                                             tdr.append(bb)
                                             #print( bb)
                                           ...
                                           # pressao.append(rows[i].contents[j].string)
                                            ...
                                            if (rows[i].contents[j].string) !=None:
                                                ...
                                                pressao.append(str(float((rows[i].contents[j].string))))
                                            else:
                                                pressao.append(rows[i].contents[j].string) 
