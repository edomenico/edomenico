...
def main():
    ...
    def get_weather_data(lat, lon, hours):
        ...
        if selusuario == "Previsor CMA-1GL":
            ...
            #url = f"https://ensemble-api.open-meteo.com/v1/forecast?latitude={lat[0]}&longitude={lon[0]}&hourly=temperature_2m,relative_humidity_2m,wind_speed_10m,wind_direction_10m,visibility,cloud_cover_low,precipitation,weather_code&forecast_days=4"
        else:
